...
ADD ./docker/config/yggdrasil/docker-entrypoint.sh    /docker-entrypoint.sh
ADD ./docker/config/yggdrasil/supervisord.conf        ./supervisord.conf
ADD ./docker/config/yggdrasil/yggdrasil.conf          ./yggdrasil.conf
