...
Для определения собственных URL картинок маскотов и прочего используются файлы `/www/css/normal.custom.css` и `/www/css/omsk.custom.css`. Примеры файлов приведены в той же директории. 
