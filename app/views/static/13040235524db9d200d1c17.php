<div class="l-static-wrap">
					<div class="b-static m-justify">
						...
						<p style="text-align:right;padding-right:10px;">
							<b>Ссылка:</b> <input type="text" value="https://" id="share_link" style="width:500px" /><br />
							<b>Описание:</b> <input type="text" id="share_desc" style="width:500px" size="50" />
							<input type="button" value="Отправить" onclick="var i=new Image();i.onload=function(){alert('Ваша ссылка принята в обработку, спасибо!');};i.onerror=function(){alert('Произошла ошибка, возможно ссылка уже была отправлена, либо вы отправили слишком много ссылок.');};i.src='https://1chan.pl/service/share/?link='+encodeURIComponent($('#share_link').val().replace(/#(.*)$/,''))+'&description='+encodeURIComponent($('#share_desc').val())+'&title='+encodeURIComponent('Отправлено через форму');$('#share_desc, #share_link').val('');" />
						</p>
						<p>
						...
						<p>
							...
							(<a href="https://ru.wikipedia.org/wiki/Букмарклет" target="_blank">что это?</a>)
						...
						<p>
							...
							завести джаббер и посетить конференцию <em>press@conference.1chan.pl</em>. 
						</p>
						<p>
						...
						<p>
							...
							может быть получен Jabber ID на сервере 1chan.pl, для внутреннего пользования.
						</p>
						<p>
							Если у вас есть желание помочь Одинчану, упорство и немного самоотдачи, то милости просим
							в конференцию <em>press@conference.1chan.pl</em>.
						</p>
					</div>
				</div> 