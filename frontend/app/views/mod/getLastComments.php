			<?php include(dirname(__FILE__) .'/../blog/chunks/blog_control.php'); ?>
				...
				<div class="l-comments-wrap">
					...
					<?php $post = Blog_BlogPostsModel::GetPost($comment['post_id']);
					$comment['post_title'] = $post['title']; ?>
					<div class="b-comment" id="comment_<?php echo($comment['id']); ?>">
						<div class="b-comment_b-info">
							<?php echo(TemplateHelper::date('d M Y @ H:i:s', $comment['created_at'])); ?>, <a href="/news/res/<?php echo($comment['post_id']); ?>/"><?php echo($comment['post_title']); ?></a>
							(<a href="/news/res/<?php echo($comment['post_id']); ?>/#<?php echo($comment['id']); ?>">#<?php echo($comment['id']); ?></a>)
					...
					<textarea id="template_comment" style="display:none">
						<div class="b-comment" id="comment_<%=id%>">
							<div class="b-comment_b-info">
								...
								<span class="js-comment-id">(<a href="/news/res/<%=post_id%>/#<%=id%>">#<%=id%></a>)</span>
								<a href="#" class="js-remove-button g-hidden">
