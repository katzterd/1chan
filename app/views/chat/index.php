					...
					<div class="js-favchatlist g-clearfix">
						...
						<div class="b-chat-rooms_b-room" id="room_<?php echo($room['room_id']); ?>">
							<div class="b-chat-rooms_b-room_b-header">
								<a href="/chat/<?php echo(!is_null($room['alias']) ? $room['alias'] : $room['room_id']); ?>/"><?php echo($room['title']); ?></a> <img src="/ico/invisible.png" width="16" height="16" alt="" class="js-hidden-room-icon<?php if($room['public']): ?> g-hidden<?php endif; ?>" /> <img src="/ico/key.gif" width="16" height="16" alt="" class="js-key-icon<?php if(empty($room['password'])): ?> g-hidden<?php endif; ?>"/>
							</div>
				...
				<div class="b-chat-rooms">
					...
					<div class="b-chat-added-notify" id="chat_notify">
						Доступны новые комнаты, <a href="/chat/">перезагрузите страницу</a>, чтобы увидеть их.
					</div>
