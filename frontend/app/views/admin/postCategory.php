                ...
                <div id="main">
						<h3>Категории:</h3>
						<input type="button" onclick="location.href='/admin/postCategoryAdd'" value="Создать категорию" /><br /><br />
                    	<?php if (empty($cats)): ?>
                    	...
                    	<?php foreach($cats as $cat): ?>
							<tr<?php if(++$i % 2): ?> class="odd"<?php endif; ?>>
                                ...
                                <td class="action"><a href="/b/cat/<?php echo $cat['name']; ?>/" class="view">View</a><a href="/admin/postCategoryEdit?id=<?php echo $cat['id']; ?>" class="edit">Edit</a><a href="/admin/postCategoryDelete?id=<?php echo $cat['id']; ?>" class="delete">Delete</a></td>
                            </tr>
                        <?php endforeach; ?>
                        </table>
