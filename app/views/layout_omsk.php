...
<html lang="ru">
	<head>
		...
		<link rel="stylesheet" type="text/css"  href="/css/omsk.css<?php echo CSS_VERSION ?>" media="all" />
		<link rel="stylesheet" type="text/css"  href="/css/omsk.custom.css<?php echo CSS_VERSION ?>" media="all" />
		...
		<div class="l-wrap">
			...
			<div class="b-header-block m-mascot m-mascot-<?php echo($this -> getParameter('board_id', 'news')); ?>">
				<div class="b-header-block_b-logotype">
					<a href="/news/all/">
						<img src="/img/<?php echo LOGO_OMSK_IMG ?>" width="250" height="80" alt="<?php echo LOGO_ALT ?>" />
					</a>
				</div>
