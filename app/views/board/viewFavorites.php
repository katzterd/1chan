				...
				<div class="b-board m-thread">
					...
					<div class="l-comments-wrap">
						...
						<div class="b-comment" id="comment_<?php echo($tail_post['board_id']); ?>_<?php echo($tail_post['id']); ?>">
							<div class="b-comment_b-info">
								<?php echo(TemplateHelper::date('d M Y @ H:i:s', $tail_post['created_at'])); ?>, <a href="/<?php echo($post['board_id']); ?>/res/<?php echo($post['id']); ?>/#<?php echo($tail_post['id']); ?>" name="<?php echo($tail_post['id']); ?>" class="js-paste-link">№<?php echo($tail_post['id']); ?></a>
